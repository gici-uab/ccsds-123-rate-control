...
public class OrderConverter {
	...
	public int getAddress(int position) {
		...
		//tmp = position-aux[pixelOrder[Geometry.Z_SIZE]]*size[pixelOrder[Geometry.X_SIZE]]*size[pixelOrder[Geometry.Y_SIZE]];
		...
		//aux[pixelOrder[Geometry.X_SIZE]] = tmp - aux[pixelOrder[Geometry.Y_SIZE]]*size[pixelOrder[Geometry.X_SIZE]];
	...
	public int getColumnOffset() {
		...
		return getAddress(1);
		/*int offset = 1;
		for(int i=2;originalPixelOrder[i] != 2;i--) {
			offset *= size[i];
		}
		return offset;*/
	}
